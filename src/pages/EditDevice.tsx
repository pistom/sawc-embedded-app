      ...
      <div className="card mb-4 mx-4 p-4 sm:mx-0">
        <form onSubmit={handleSubmit} className="form sm:flex sm:items-start">
          <div className="w-full">
            ...
            <input type="text" className="mb-2" placeholder="Name" value={deviceName} onChange={handleDeviceNameChange} />
            ...
            <input type="text" className="mb-2" placeholder="Name" value={defaultRatio} onChange={handleDefaultRatio} />
